...
/obj/machinery/suit_cycler
	...
	var/list/species = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_MOUSE,SPECIES_TAJARA,SPECIES_RESOMI)
...
/obj/machinery/suit_cycler/engineering
	...
	species = list(SPECIES_HUMAN,SPECIES_TAJARA,SPECIES_SKRELL,SPECIES_MOUSE,SPECIES_RESOMI) //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list(SPECIES_HUMAN,SPECIES_TAJARA,SPECIES_SKRELL,SPECIES_MOUSE,SPECIES_RESOMI)
