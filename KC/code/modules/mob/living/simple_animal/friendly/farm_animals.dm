/mob/living/simple_animal
	var/remains_type = /obj/item/stack/material/wetleather
...
/mob/living/simple_animal/cow
	name = "cow"
	desc = "Known for their milk, just don't tip them over. Male cow, wait that can't be right?"
	icon_state = "cow"
	icon_living = "cow"
	icon_dead = "cow_dead"
	icon_gib = "cow_gib"
...
/mob/living/simple_animal/cow/female
	name = "female cow"
	desc = "Female cow... wait aren't all cows female?"

/mob/living/simple_animal/cow/female/Life()
	. = ..()
	if(stat == CONSCIOUS)
		if(udder && prob(5))
			udder.add_reagent("milk", rand(5, 10))
		...
		if(turns_since_scan > 90)
			...
			if(ian)
				if(near_camera(src) || near_camera(ian))
					return
				new /mob/living/simple_animal/cow/calf(loc)
