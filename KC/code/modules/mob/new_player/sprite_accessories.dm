...
/datum/sprite_accessory/hair
	...
	bald
		...
		icon_state = "bald"
		gender = MALE
		species_allowed = list(SPECIES_HUMAN,SPECIES_MOUSE)
		veryshort = 1
...
/datum/sprite_accessory/facial_hair
	...
	shaved
		...
		icon_state = "bald"
		gender = NEUTER
		species_allowed = list(SPECIES_HUMAN,SPECIES_MOUSE,SPECIES_TAJARA,SPECIES_SKRELL,SPECIES_VOX,SPECIES_IPC)
...
/datum/sprite_accessory/skin
	...
	mouse
		name = "Default Mouse skin"
		icon_state = "default"
		icon = 'icons/mob/human_races/r_lizard.dmi'
		species_allowed = list(SPECIES_MOUSE)
