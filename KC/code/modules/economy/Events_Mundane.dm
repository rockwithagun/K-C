	...
	if(!body)
		...
		switch(event_type)
			...
			if(MOVIE_RELEASE)
				...
				[pick("Deadly","The last","Lost","Dead")] [pick("Starships","Warriors","outcasts","Tajarans",SPECIES_MOUSE,SPECIES_SKRELL)] \
...
/datum/event/trivial_news/announce()
	...
	"[pick(SPECIES_MOUSE,"Spacer")] gets tattoo of Nyx on chest '[pick("[using_map.boss_short]","star","starship","asteroid")] tickles most'.",\
