...
/obj/item/clothing/head/king/fancy
	name = "fancy leather hat"
	desc = "A fancy black leather hat with gold trim."
	icon_state = "fancyleatherhat"
	item_state = "fancyleatherhat"
	siemens_coefficient = 0.9
	body_parts_covered = 0

/obj/item/clothing/head/king/generic
	name = "leather hat"
	desc = "A generic black leather hat."
	icon_state = "leatherhat"
	item_state = "leatherhat"
	siemens_coefficient = 0.9
	body_parts_covered = 0

/obj/item/clothing/head/king/gus
	name = "gus hat"
	desc = "A gus styled leather hat."
	icon_state = "gus"
	item_state = "gus"
	siemens_coefficient = 0.9
	body_parts_covered = 0