...
/obj/item/clothing/head/helmet/tactical
	...
	sprite_sheets = list(
		...
		SPECIES_MOUSE = 'icons/mob/species/MOUSE/helmet.dmi'
		)
...
//King&Cunt
/obj/item/clothing/head/helmet/king
	name = "helmet"
	desc = "A helmet with a closed facemask."
	icon_state = "greynhelmet"
	armor = list(melee = null)
	flags_inv = HIDEEARS|HIDEEYES
	body_parts_covered = HEAD|EYES|BLOCKHEADHAIR
	cold_protection = HEAD

/obj/item/clothing/head/helmet/king/material/heavy
	name = "helmet"
	desc = "A helmet with a closed facemask."
...
/obj/item/clothing/head/helmet/king/brown
	name = "brown helmet"
	desc = "A helmet with a closed facemask."
	icon_state = "brownhelmet"
	armor = list(melee = 20)

/obj/item/clothing/head/helmet/king/green
	name = "green helmet"
	desc = "A helmet with a closed facemask."
	icon_state = "greenhelmet"
	armor = list(melee = 30)

/obj/item/clothing/head/helmet/king/blue
	name = "blue helmet"
	desc = "A helmet with a closed facemask."
	icon_state = "bluehelmet"
	armor = list(melee = 40)

/obj/item/clothing/head/helmet/king/heavy
	name = "kings helmet"
	desc = "A kings helmet with a closed facemask."
	icon_state = "ironhelmet"
	armor = list(melee = 50)

/obj/item/clothing/head/helmet/king/crown
	name = "gold crown"
...
/obj/item/clothing/head/helmet/king/material/med
	...
	flags_inv = HIDEEARS
	body_parts_covered = HEAD|BLOCKHEADHAIR