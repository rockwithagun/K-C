...
/obj/item/clothing/head/helmet/space/rig/industrial
	...
	species_restricted = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_TAJARA,SPECIES_MOUSE)
...
/obj/item/clothing/head/helmet/space/rig/hazard
	...
	species_restricted = list(SPECIES_HUMAN,SPECIES_SKRELL,SPECIES_TAJARA,SPECIES_MOUSE) //still needs Resomi sprites
