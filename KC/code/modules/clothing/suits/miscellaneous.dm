...
/obj/item/clothing/suit/king/apron
	...
	icon_state = "apron"
	item_state = "apron"
	armor = list(melee = 7, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0)

/obj/item/clothing/suit/king/apronwhite
	name = "apron"
	desc = "A white stained leather apron."
	icon_state = "whiteapron"
	item_state = "whiteapron"
	armor = list(melee = 7, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0)