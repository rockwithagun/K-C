...
//King&Cunt
/obj/item/clothing/suit/armor/king/
	name = "heavy armour"
	desc = "A heavy suit of armour."
	icon_state = "brownarmour"
	item_state = "brownarmour"
	armor = list(melee = null)
	w_class = ITEM_SIZE_HUGE//bulky item
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|FEET|ARMS|HANDS
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT

/obj/item/clothing/suit/armor/king/material/heavy
	name = "heavy armour"
	desc = "A heavy suit of armour."
...
/obj/item/clothing/suit/armor/king/brown
	name = "heavy armour"
	desc = "A heavy suit of armour."
	icon_state = "brownarmour"
	item_state = "brownarmour"
...
/obj/item/clothing/suit/armor/king/green
	name = "heavy armour"
	desc = "A heavy suit of armour."
	icon_state = "greenarmour"
	item_state = "greenarmour"
	armor = list(melee = 40)

/obj/item/clothing/suit/armor/king/blue
	name = "heavy armour"
	desc = "A heavy suit of armour."
	icon_state = "bluearmour"
	item_state = "bluearmour"
	armor = list(melee = 50)

/obj/item/clothing/suit/armor/king/heavy
	name = "heavy kings armour"
	desc = "A heavy suit of kings armour."
	icon_state = "ironarmor"
	item_state = "ironarmor"
	armor = list(melee = 60)

/obj/item/clothing/suit/armor/king/material/medium
	name = "medium armour"
	desc = "A medium suit of armour."
	icon_state = "medarmour"
	item_state = "medarmour"
	armor = list(melee = 25)
