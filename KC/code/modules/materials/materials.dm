...
material/proc/silver_vamp_damage()
	return hardness //todo
...
/material/silver/pickup(mob/living/user as mob,  var/obj/item/W)
	if(isvampire(user))
		to_chat(user, "<span class='warning'>Your skin burns as you touch the silver!</span>")
		user.Stun(3)
		user.take_organ_damage(5, 15)
	return
