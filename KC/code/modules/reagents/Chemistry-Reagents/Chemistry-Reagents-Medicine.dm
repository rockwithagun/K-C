...
/datum/reagent/solidfailure
	name = "goey mess"
	id = "solidfail"
	reagent_state = SOLID

/datum/reagent/liquidfailure
	name = "muddy water"
	id = "liquidfail"
	reagent_state = LIQUID

/datum/reagent/gasfailure
	name = "nothing at all"
	id = "gasfail"
	reagent_state = GAS
...
/datum/reagent/corporis
	...
	id = "corporis"
	description = "A unrefined healing reagent commonly found in the plant solaria."
	color = "#e16496"
	overdose = REAGENTS_OVERDOSE
	reagent_state = LIQUID
	states = list(SOLID = "solaris", LIQUID = "corporis", GAS = "corporismedium")
	state_change_msg = list(SOLID = "solidifies into a orange blob.", LIQUID = "liquefies into a muddy color.", GAS = "evaporates into a grey cloud.")
...
/datum/reagent/corporismedium
	...
	overdose = REAGENTS_OVERDOSE
	reagent_state = GAS
	states = list(SOLID = "solidfail", LIQUID = "corporispura", GAS = "gasfail")
	state_change_msg = list(SOLID = "solidifies into a mess.", LIQUID = "liquefies into a bright pink", GAS = "evaporates into nothing.")

/datum/reagent/corporismedium/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_STABLE)

/datum/reagent/corporispura
	name = "corporis remedium pura"
	id = "corporispura"
	color = "#ff7de1"
	overdose = REAGENTS_OVERDOSE
	reagent_state = LIQUID
...
/datum/reagent/corporispura/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.heal_organ_damage(7.5 * removed, 0)

/datum/reagent/argentum
	name = "argentum potabile"
	id = "argentum"
	taste_description = "silver"
	reagent_state = LIQUID
	color = "#e5e5e5"
	states = list(SOLID = "silver", LIQUID = "argentum", GAS = "purifiedsilver")
