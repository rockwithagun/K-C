...
/obj/item/weapon/reagent_containers/food/snacks/rawsticks
	...
	desc = "Raw sticks, not very tasty."
	icon = 'icons/obj/food_ingredients.dmi'
...
/obj/item/weapon/reagent_containers/food/snacks/tastybread/bread
	name = "bread"
	desc = "Bread."
	icon_state = "bread"
	trash = null
...
/obj/item/weapon/reagent_containers/food/snacks/snacks/king/flour
	name = "flour"
	desc = "It's some flour."
	icon_state = "flour"
	trash = null
	filling_color = "#A66829"
	center_of_mass = "x=17;y=16"
...
/obj/item/weapon/reagent_containers/food/snacks/tastybread/bread/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W,/obj/item/weapon/material/kitchen/utensil/knife))
		new /obj/item/weapon/reagent_containers/food/snacks/twobread(src)
		to_chat(user, "You cut the bread.")
		qdel(src)
	else
		..()

/obj/item/weapon/reagent_containers/food/snacks/twobread/attack_self(mob/user as mob)
	new /obj/item/weapon/reagent_containers/food/snacks/csandwich(src)
	to_chat(user, "You make a sandwich.")
	qdel(src)
else
		..()
...
/obj/item/weapon/reagent_containers/food/snacks/grown/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W,/obj/item/weapon/material/kitchen/utensil/knife))
		new /obj/item/weapon/reagent_containers/food/snacks/snacks/king/flour (src)
		to_chat(user, "You make flour out of the [name].")
		qdel(src)
	else
		..()