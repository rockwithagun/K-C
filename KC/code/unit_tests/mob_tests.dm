...
datum/unit_test/mob_damage/mouse
	name = "MOB: Unathi damage check template"
	mob_type = /mob/living/carbon/human/mouse

datum/unit_test/mob_damage/mouse/brute
	name = "MOB: Unathi Brute Damage Check"
	damagetype = BRUTE
	expected_vulnerability = ARMORED

datum/unit_test/mob_damage/mouse/fire
	name = "MOB: Unathi Fire Damage Check"
	damagetype = BURN

datum/unit_test/mob_damage/mouse/tox
	name = "MOB: Unathi Toxins Damage Check"
	damagetype = TOX

datum/unit_test/mob_damage/mouse/oxy
	name = "MOB: Unathi Oxygen Damage Check"
	damagetype = OXY

datum/unit_test/mob_damage/mouse/clone
	name = "MOB: Unathi Clone Damage Check"
	damagetype = CLONE

datum/unit_test/mob_damage/mouse/halloss
