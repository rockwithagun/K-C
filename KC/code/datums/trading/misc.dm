...
/datum/trader/ship/replica_shop
	...
	speech = list("hail_generic" = "Welcome, welcome! You look like a man who appreciates human history. Come in, and learn! Maybe even.... buy?",
				"hail_Mouse"    = "Ah, you look like a lizard who knows his way around martial combat. Come in! Our stuff may not be as high quality as you are used to, but feel free to look around.",
				...
				"bribe_refusal"  = "Well. I'd love to stay, but I've got an Mouse client somewhere else, and they are not known for patience.",
